...
PFNGLMULTIDRAWELEMENTSPROC __glewMultiDrawElements = (PFNGLMULTIDRAWELEMENTSPROC)mockgl_MultiDrawElements;
...
PFNGLSHADERSOURCEPROC __glewShaderSource = (PFNGLSHADERSOURCEPROC)mockgl_ShaderSource;
...
PFNGLTRANSFORMFEEDBACKVARYINGSPROC __glewTransformFeedbackVaryings = (PFNGLTRANSFORMFEEDBACKVARYINGSPROC)mockgl_TransformFeedbackVaryings;
